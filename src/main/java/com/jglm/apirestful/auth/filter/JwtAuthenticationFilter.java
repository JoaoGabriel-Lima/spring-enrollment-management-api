package com.jglm.apirestful.auth.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Vamos extrair do token o id do usuário e o role para que não seja preciso
        // acessar o banco de dados
        // Quando criamos o token, armazenamos nele, como Claims o nome, email e o Role
        // do usuário.
        ...
        // Aqui, através da classe UsernamePasswordAuthenticationToken, a gente cria um
        // objeto
        // de autenticação, isto é, um objeto que irá conter o id do usuário e seu
        // perfil (role) .
        // Esse construtor de UsernamePasswordAuthenticationToken espera receber um
        // object (que
        // pode ser o objeto usuário completo ou apenas o id do usuário), as credenciais
        // e os
        // perfis. Se vc quiser passar o objeto usuário completo, você terá que
        // recuperá-lo do
        ...
        // Com a linha de código abaixo estamos adicionando ao authenticationToken mais
        // algumas
        // informações que estão no objeto request, como endereço ip e a sessão do
        // usuário
        // se aplicável. No nosso caso, como JWT é stateless não há sessão de usuário.

        authenticationToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));

        // Abaixo estamos salvando no SecurityContextHolder informações sobre o usuário
        // autenticado
        // para que estas informações possam ser recuperadas antes de um controller ser
        // acessado para
        // verificar se o usuário possui o role necessário para acessar o recurso.

        SecurityContextHolder.getContext().setAuthentication(authenticationToken);

        // Passa a requisição para o próximo filter ou para o controller (se não houver
        // um próximo filter)

        filterChain.doFilter(request, response);

        // Se houver uma linha de código aqui ela será executada após o controller ser
        // executado.
