...
public class JwtService {
    ...
    // nome (.env) deve ser adicionado a .gitignore para não ser salvo no
    // repositório.
    ...
    public Claims getClaims(String token) {
        // Primeiro é preciso ciar um parser para validar o token. O método parser()
        // funciona como um builder.
        // Claims - reivindicações ou declarações - refere-se às informações contidas no
        // payload. Existem
        // claims padrão como subject e iat, e claims definidos pelo usuário como: nome,
        // role, etc
